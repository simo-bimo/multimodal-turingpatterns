...
Model.to_file(variedgs, "data/variedgs-medium3", frames=2600, steps_per_frame=20)
Model.create_animation("variedgs/medium2", "data/variedgs-medium3", "Inhibitor", frame_count=2600)